...
with open('/Users/aarav/Desktop/Securities in emerging technology/Class Projects/Yolo Detection/public_prediction.txt','r') as f:
    l.append(f.read())
...
for i in l:
    with open('/Users/aarav/Desktop/Securities in emerging technology/Class Projects/Yolo Detection/final_format_public.txt','a+') as f:
        f.write(f"{i}")